...
export const routeLogger = () => {
  return expressWinston.logger({
    ...
    msg: "{{req.method}} {{req.url}} || ({{res.responseTime}}ms) || (Status = {{res.statusCode}})", // optional: customize the default logging message. E.g. "{{res.statusCode}} {{req.method}} {{res.responseTime}}ms {{req.url}}"
